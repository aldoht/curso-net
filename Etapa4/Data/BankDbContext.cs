...
public partial class BankDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC27E09FDD03");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC27B046AE2A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC27C19B362E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC2742F4428D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC270AF587EB");
